...
class ControllerModuleVisFacebookPixel extends Controller {
    ...
    public function index() {
        ...
        $data['breadcrumbs'][] = array(
            ...
            'href' => $this->url->link('module/vis_facebook_pixel', 'token=' . $this->session->data['token'], 'SSL')
        );

        $data['action'] = $this->url->link('module/vis_facebook_pixel', 'token=' . $this->session->data['token'], 'SSL');
